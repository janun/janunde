    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settings', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.SocialMediaSettings')),
            ],
        ),
    ]
